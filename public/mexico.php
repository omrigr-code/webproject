    ...
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <h1>Salsa Verde</h1>
                <p> the most addictive dip I’ve tasted recently- is Salsa Verde. This delicious Mexican green (Verde) salsa is made with roasted tomatillos, chili peppers, lime juice, cilantro, garlic, and onion. You can dip it with chips, spread it on meat, or add it to your tacos! This salsa is crazy delicious. Huge YASSS here. </p>
            </div>
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Salsa Verde.jpeg" alt="main picture" height="700">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="accordion-item">
        ...
        <div id="collapseTwo" class=" collapse" aria-labelledby="headingTwo" data-bs-parent="#Description">
            <div class="accordion-body">
                ...
                - Cut the onion in half. One half we will roast and the other half we will chop and add raw to the salsa.<br>
                - Remove the stems from the peppers.<br>
                - Set your grill on medium heat (you can also broil in the oven). <br>
                - Place the tomatillos, peppers, and onion onto the grill and roast them until lightly blackened.<br>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Chili con carne.jpeg" alt="main picture" height="700">
            </div>
            <div class="col-lg-6 col-md-12">
...
<div class="accordion" id="Description">
    ...
    <div class="accordion-item">
        ...
        <div id="collapse4" class=" collapse " aria-labelledby="heading4" data-bs-parent="#Description">
            <div class="accordion-body">
                -Place a large non-stick saucepan over a medium heat and add the beef and onions. Cook together for 5 minutes, stirring the beef and squishing it against the sides of the pan to break up the lumps. Add the garlic, 1–2 teaspoons of chili powder, depending on how hot you like your chilli, and the cumin and coriander. Fry together for 1–2 minutes more. Sprinkle over the ﬂour and stir well. <br>
                -Slowly add the wine and then the stock, stirring constantly. Tip the tomatoes and kidney beans into the pan and stir in the tomato purée, caster sugar, oregano and bay leaf. Season with a pinch of salt and plenty of freshly ground black pepper.<br>
                -Bring to a simmer on the hob, then cover loosely with a lid. Reduce the heat and leave to simmer gently for 45 minutes, stirring occasionally until the mince is tender and the sauce is thick. Adjust the seasoning to taste and serve.<br>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <h1>churros</h1>
                <p>A churro is a type of fried dough from Spanish and Portuguese cuisine. churros can either be thin (and sometimes knotted) or long and thick, and served with chocolate or maple</p>
            </div>
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Choroos.jpeg" alt="main picture" height="700">
            </div>
        </div>
    </div>
</section>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Paloma cocktail.jpeg" alt="main picture" height="700">
            </div>
            <div class="col-lg-6 col-md-12">
...
<div class="accordion" id="Description">
    ...
    <div class="accordion-item">
        ...
        <div id="collapse8" class=" collapse " aria-labelledby="heading8" data-bs-parent="#Description">
            <div class="accordion-body">
                - Rim the glass with salt. It does not just look cute! The salt enhances the overall flavor of the drink. How to make the perfect salt rim? See below. <br>
                - Stir tequila, grapefruit, lime, and syrup in the glass. This cocktail is so simple, you do not even need to dirty up a cocktail shaker! Mix it all together in the glass.<br>
                - Add ice and top with soda water. Fill the glass with ice and top with soda water. A grapefruit wedge makes a nice garnish<br>
