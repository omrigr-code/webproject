    ...
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <h1>Gazpacho</h1>
                <p>Gazpacho is a cold soup made of raw fresh veggies, stale bread, vinegar, garlic, and olive oil. </p>
            </div>
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Gazpacho.jpeg" alt="main picture" height="700">
            </div>
        </div>
    </div>
</section>
...
<div class="accordion" id="Description">
    ...
    <div class="accordion-item">
        ...
        <div id="collapseTwo" class=" collapse" aria-labelledby="headingTwo" data-bs-parent="#Description">
            <div class="accordion-body">
                - Peel the cucumbers and cut them into small pieces (doesn’t matter how you cut them, it just makes it easier to blend). <br>
                ...
                - Serve in a bowl with ice cubes. Finish with bread croutons, chopped cucumber, basil, and olive oil.<br>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Squid Ink Ravioli (stuffed with egg-yolk).jpeg" alt="main picture" height="700">
            </div>
            <div class="col-lg-6 col-md-12">
                <h1>Squid Ink Ravioli (stuffed with egg-yolk)</h1>
                <p>an egg-yolk stuffed ravioli - the dough with squid ink This pasta is so gorgeous in color! And with a runny egg yolk inside? Mamma Mia! There is no reason to make a sauce- it's all in the ravioli. If you want to surprise your lovers with a super special pasta dish- this is your go-to! </p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="accordion-item">
        ...
        <div id="collapse4" class=" collapse " aria-labelledby="heading4" data-bs-parent="#Description">
            <div class="accordion-body">
                ...
                - Once the flour is incorporated with the liquids into crumbs start to knead the dough by hand. Knead the dough for about 10 minutes until you get a beautiful smooth ball. <br>
                - Cover the dough with plastic wrap and let it rest for an hour. You can prepare the dough a day in advance and place it in the fridge.<br>
                ...
                - Place one sheet on the working surface. Start piping the filling on the sheet. Pipe it is leaving a space in the ricotta for the egg yolk.<br>
                - Add the egg yolk to the ricotta and cover with the second pasta sheet.<br>
                - Tight the pasta sheets to each other, trying to remove all the air that remained in between the sheets. We want to avoid any air pockets in the ravioli.<br>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <h1>Tiramisù</h1>
                <p>a classic tiramisù can be transcendent. A creamy dessert of espresso-soaked ladyfingers surrounded by lightly sweetened whipped cream and a rich mascarpone, tiramisù relies heavily on the quality of its ingredients.</p>
            </div>
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Tiramisù.jpeg" alt="main picture" height="700">
            </div>
        </div>
    </div>
</section>
...
<div class="accordion" id="Description">
    ...
    <div class="accordion-item">
        ...
        <div id="collapse6" class=" collapse " aria-labelledby="heading6" data-bs-parent="#Description">
            <div class="accordion-body">
                - Using an electric mixer in a medium bowl, whip together egg yolks and 1/4 cup/50 grams sugar until very pale yellow and about tripled in volume. A slight ribbon should fall from the beaters (or whisk attachment) when lifted from the bowl. Transfer mixture to a large bowl, wiping out the medium bowl used to whip the yolks and set aside. <br>
                - In the medium bowl, whip cream and remaining 1/4 cup/50 grams sugar until it creates soft-medium peaks. Add mascarpone and continue to whip until it creates a soft, spreadable mixture with medium peaks. Gently fold the mascarpone mixture into the sweetened egg yolks until combined.<br>
                - Combine espresso and rum in a shallow bowl and set aside.<br>
                - Using a sifter, dust the bottom of a 2-quart baking dish (an 8x8-inch dish, or a 9-inch round cake pan would also work here) with 1 tablespoon cocoa powder.<br>
                - Working one at a time, quickly dip each ladyfinger into the espresso mixture -- they are quite porous and will fall apart if left in the liquid too long -- and place them rounded side up at the bottom of the baking dish. Repeat, using half the ladyfingers, until you’ve got an even layer, breaking the ladyfingers in half as needed to fill in any obvious gaps (a little space in between is O.K.). Spread half the mascarpone mixture onto the ladyfingers in one even layer. Repeat with remaining espresso-dipped ladyfingers and mascarpone mixture.<br>
                - Dust top layer with remaining tablespoon of cocoa powder. Top with shaved or finely grated chocolate, if desired.<br>
                - Cover with plastic wrap and let chill in the refrigerator for at least 4 hours (if you can wait 24 hours, all the better) before slicing or scooping to serve.<br>
...
<section id="head">
    <div class="container-fluid">
        <div class="row rowwidth">
            <div class="col-lg-6 col-md-12">
                <img class="img-me" src="/assets/recipes/Negroni sbagliato.jpeg" alt="main picture" height="700">
            </div>
            <div class="col-lg-6 col-md-12">
